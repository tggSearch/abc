...
看不懂的看下面的图片教程！！！！！！
1. 使用上面的体制注册地址链接去注册（[梯子注册地址](https://www.三毛机场.xyz/#/register?code=gVj9CTrz)），里面有一个订阅服务，建议选择5块一个月的就行<font color="#dd0000">（如果觉得1个月10G够用，你可以选择1一年3块的服务，如果你觉得5块的也不够，可以选择8块的）</font>；
